...
//     private readonly RequestFactory $requestFactory,
  ...
  protected \Google\Client|null $googleClient = null;
    ...
    {
        $token = [];
        $queryBuilder = GeneralUtility::makeInstance(ConnectionPool::class)->getQueryBuilderForTable('tx_gdprextensionscomcm_domain_model_connections');
        $token = $queryBuilder
        ->select('apitoken')
        ->from('tx_gdprextensionscomcm_domain_model_connections')
        ->where(
