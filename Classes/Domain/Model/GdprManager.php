...
class GdprManager extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * locations
     *
     * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\GdprExtensionsCom\GdprExtensionsComCm\Domain\Model\MapLocation>
     ...
     * Adds a MapLocation
     *
     * @param \GdprExtensionsCom\GdprExtensionsComCm\Domain\Model\MapLocation $location
     * @return void
     */
    public function addLocation(\GdprExtensionsCom\GdprExtensionsComCm\Domain\Model\MapLocation $location)
    {
     ...
     *
     * @param \GdprExtensionsCom\GdprExtensionsComCm\Domain\Model\MapLocation $locationToRemove The MapLocation to be removed
     * @return void
     */
    public function removeLocation(\GdprExtensionsCom\GdprExtensionsComCm\Domain\Model\MapLocation $locationToRemove)
    {
